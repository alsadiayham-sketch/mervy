...
var cart = normalizeCartItems(JSON.parse(localStorage.getItem('mervy_cart') || '[]'), normalizeProducts(DEFAULT_PRODUCTS));
var deliveryMethod = localStorage.getItem('mervy_delivery_method') || 'delivery';
...
function saveCart() {
    localStorage.setItem('mervy_cart', JSON.stringify(normalizeCartItems(cart, products.length ? products : normalizeProducts(DEFAULT_PRODUCTS))));
}

function setDeliveryMethod(method) {
    deliveryMethod = method;
    localStorage.setItem('mervy_delivery_method', method);
