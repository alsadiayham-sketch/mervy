...
var DEFAULT_SITE_SETTINGS = {
    whatsappNumber: '972525918196',
    heroSubtitle: 'من أرقى دور الأزياء العالمية',
    aboutText: 'ميرفي فاشنيستا\nمن أرقى دور الأزياء العالمية\nموقعنا: نابلس - رفيديا بجانب مطعم الأماكن\nتوصيل للضفة القدس الداخل\nتبديل خلال ثلاثة ايام فقط',
    instagramLink: 'https://www.instagram.com/mervyfashionista/',
    tiktokLink: ''
};

var BRANDS_DATA = [{ name: 'Mervy', logo: 'logo.png' }];
